		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MovieApp",
									"targetURL": "#opensapmovies-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensapmovies-display": {
								"semanticObject": "opensapmovies",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.movies",
									"url": sap.ui.require.toUrl("opensap/movies")
								}
							}
						}
					}
